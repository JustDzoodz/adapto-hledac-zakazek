...
if pocet_vybranych > 0:
    ...
    if pocet_vybranych > 15:
        st.warning("⚠️ Vybrali jste více než 15 webů naráz. Doporučujeme weby kontrolovat po menších skupinách.")
        ...
        for i, (nazev_webu, odkaz_webu) in enumerate(vybrane_portaly.items()):
            with tabs[i]:
                ...
                try:
                    ...
                    # 🔥 KONEČNĚ ROBUSTNÍ ANTIBLOKAČNÍ HLAVIČKY (Předstíráme čistý Chrome z Windows)
                    headers = {
                    ...
                    prompt = f"""
                    Jsi špičkový analytik veřejných zakázek specializovaný na stavby v krajině, vodní hospádařství a ekologická opatření.
